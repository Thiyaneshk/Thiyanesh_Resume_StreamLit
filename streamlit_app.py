...
txt('10/2018 - 07/2022', ' ')
st.markdown('''
- Migration of Citi banks application from Sybase to Oracle in view to
implement most secure and robust financial reporting application. Gathered, defined and refined requirements, led DB/Application design
and oversaw implementation with team of 20.
- Experience with Data flow diagrams, Data dictionary, Database
normalization with deep understanding in Oracle DB architecture.
- Automated EUC files into automated reports as value-adds to user, which
reduced 1hr of human effort per day and reduced cost-to-company of
$250,000 per year.
- Created application utility package with custom functions and
autonomous logging, improving code reusability and code quality.
- Experience in Oracle supplied packages, Dynamic SQL, Records and
PL/SQL Tables. Loaded data into Oracle tables using SQL Loader. 
- Effectively made use of Table, Views, Constraints, Indexes, partitioning, collections, Analytic functions, Materialized views, Query re-write, et al.
- Expertise in Dynamic SQL, Ref cursors, Collections, exception handling, SQL performance tuning using Cost-Based optimization. 
- Created Python/Shell scripts for data loading, integration, maintenance, data quality check and used Oracle Migration tool used for migration of
Sybase Procedure to Oracle Packages/Procedures.
- Developed/Deployed the solutions to clients in short deadlines
effectively in Agile in bi-weekly sprint releases.
''')
